...
namespace gcgg::instructions
{
  ...
  class M190 final : public delay_instruction
  {
  public:
    static constexpr const uint64 type = hash("M190");
  ...
  public:
    M190(const gc::command & __restrict cmd) : delay_instruction(type),
